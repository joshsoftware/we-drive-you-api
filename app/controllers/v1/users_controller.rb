...
module V1
  class UsersController < BaseController
    ...
    def invite_code
      render_json(message: I18n.t("create.failure", model_name: "User"), data: "Invite code is not match", status_code: :unprocessable_entity) unless params[:user][:invite_code] == current_tenant.invite_code
    end
    ...
    def address_params
      %i[address_line_1 address_line_2 city state pincode country id]
    end
  end
end
